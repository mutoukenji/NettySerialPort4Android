 ...
 * {@link DefaultSerialPortChannelConfig} allows the following options in the option map:
 *
 * <table border="1" cellspacing="0" cellpadding="6">
 * <tr>
 * <th>Name</th><th>Associated setter method</th>
 * </tr><tr>
 * <td>{@link SerialPortChannelOption#BAUD_RATE}</td><td>{@link #setBaudrate(int)}</td>
 * </tr><tr>
 * <td>{@link SerialPortChannelOption#DTR}</td><td>{@link #setDtr(boolean)}</td>
 * </tr><tr>
 * <td>{@link SerialPortChannelOption#RTS}</td><td>{@link #setRts(boolean)}</td>
 * </tr><tr>
 * <td>{@link SerialPortChannelOption#STOP_BITS}</td><td>{@link #setStopbits(Stopbits)}</td>
 * </tr><tr>
 * <td>{@link SerialPortChannelOption#DATA_BITS}</td><td>{@link #setDatabits(Databits)}</td>
 * </tr><tr>
 * <td>{@link SerialPortChannelOption#PARITY_BIT}</td><td>{@link #setParitybit(Paritybit)}</td>
 * </tr><tr>
 * <td>{@link SerialPortChannelOption#WAIT_TIME}</td><td>{@link #setWaitTimeMillis(int)}</td>
 * </tr>
 * </table>
 *
...
public interface SerialPortChannelConfig extends ChannelConfig {
    enum Stopbits {
         ...
         */
        STOPBITS_1(SerialPort.STOP_BIT_1),
        /**
         * 2 stop bits will be sent at the end of every character
         */
        STOPBITS_2(SerialPort.STOP_BIT_2);
//        /**
...
//        MARK(SerialPort.PARITY_MARK),
     ...
     */
    SerialPortChannelConfig setStopbits(Stopbits stopbits);
     ...
     */
    SerialPortChannelConfig setDatabits(Databits databits);
     ...
     */
    SerialPortChannelConfig setParitybit(Paritybit paritybit);
     ...
     */
    SerialPortChannelConfig setDtr(boolean dtr);
     ...
     */
    SerialPortChannelConfig setRts(boolean rts);
     ...
     */
    SerialPortChannelConfig setWaitTimeMillis(int waitTimeMillis);
    ...
    @Override
    SerialPortChannelConfig setWriteBufferWaterMark(WriteBufferWaterMark writeBufferWaterMark);
