 ...
 */
@Deprecated
public class SerialPortDeviceAddress extends SocketAddress {
    ...
    /**
     * Creates a SerialPortDeviceAddress representing the address of the serial port.
     *
     * @param value the address of the device (e.g. COM1, /dev/ttyUSB0, ...)
     */
    public SerialPortDeviceAddress(String value) {
        this.value = value;
    }
